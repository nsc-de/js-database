...
describe('Database', () => {
  ...
  describe('#set()', () => {
    ...
    it('test deep set with wrong type (number) (should throw error)', () => {
      const object = new db.SyncDatabase(dummyAdapter, {test: "test", test2: 1});
    ...
    it('test deep set with wrong type (boolean) (should throw error)', () => {
      const object = new db.SyncDatabase(dummyAdapter, {test: "test", test2: true});
  ...
  describe('#reloadData()', () => {
    it('test save', async () => {
      let database = (new db.SyncDatabase({
        load: () => { return {testData: "test"}; },
